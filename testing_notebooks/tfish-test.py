...
# Nl = 6 # number
# min_l = 2 # minimum
l_bins = np.arange(2, 123, 20)
Nl = len(l_bins)-1
print("binned lmax: %d,"%(np.max(l_bins)),"HEALPix lmax: %d"%lmax)
...
# FISHER
fish_out = '/projects/QUIJOTE/Oliver/polybin_testing/test_tfish%d_%d.npy'%(option,fish_index)
...
# IDEAL NUMERATOR
ideal_out = '/projects/QUIJOTE/Oliver/polybin_testing/test_tnum%d_ideal%d.npy'%(option,fish_index)
...
optimal_out = '/projects/QUIJOTE/Oliver/polybin_testing/test_tnum%d_opt%d.npy'%(option,fish_index)
optimal_out02 = '/projects/QUIJOTE/Oliver/polybin_testing/test_tnum%d_opt%d_no02.npy'%(option,fish_index)
