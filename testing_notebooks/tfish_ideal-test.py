...
tspec = pb.TSpec(base, mask, applySinv, l_bins)
...
# IDEAL FISHER
fish_out = '/projects/QUIJOTE/Oliver/polybin_testing/test-tfish_ideal_%d_%d_%d.npy'%(min_l,dl,Nl)
